...
namespace Luthier.Geometry.Test
{
    ...
    public class BSplineAlgorithmTests
    {
        ...
        public void BasisFunction_EvaluateDerivative_Deboor()
        {
            ...
            double n0 = Luthier.Geometry.Nurbs.Algorithm.BasisFunction_EvaluateDerivative_Deboor(0, 0, degree, knotIX, ref knot, t);
            double d1n0 = Luthier.Geometry.Nurbs.Algorithm.BasisFunction_EvaluateDerivative_Deboor(1, 0, degree, knotIX, ref knot, t);
            double d2n0 = Luthier.Geometry.Nurbs.Algorithm.BasisFunction_EvaluateDerivative_Deboor(2, 0, degree, knotIX, ref knot, t);
        ...
        public void CurveSpan_Evaluate_Deboor()
        {
            ...
            var cxt = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, knotIX, ref knot, ref cvDataBlock, 0, cvStride, t);
            var cyt = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, knotIX, ref knot, ref cvDataBlock, 1, cvStride, t);
        ...
        public void NurbsEvaluationSingleSpan_UnevenKnot()
        {
            ...
            var _px = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, 2, ref knot, ref cvblock, 0, 2, 3.2);
            var _py = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, 2, ref knot, ref cvblock, 1, 2, 3.2);
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                px[i] = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, 2, ref knot, ref cvblock, 0, 2, t);
                py[i] = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree, 2, ref knot, ref cvblock, 1, 2, t);
            }
        ...
        //    double px = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree,  1, ref knot, ref cvblock, 0, 2, 1.2);
        //    double pxh = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_Evaluate_Deboor(degree,  1, ref knot, ref cvblock, 0, 2, 1.2 + h);
        //    double forwardDiffDeriv = (pxh - px) / h;

        //    double derivpx = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_EvaluateFirstDerivative_Deboor(degree, 1, ref knot, ref cvblock, 0, 2, 1.2);

        //    double deriv0 = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_EvaluateDerivative_Deboor(0, degree, 1, ref knot, ref cvblock, 0, 2, 1.2);
        //    double deriv1 = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_EvaluateDerivative_Deboor(1, degree, 1, ref knot, ref cvblock, 0, 2, 1.2);
        //    double deriv2 = Luthier.Geometry.Nurbs.Algorithm.CurveSpan_EvaluateDerivative_Deboor(2, degree, 1, ref knot, ref cvblock, 0, 2, 1.2);
        ...
        [TestMethod]
        public void NurbsSurfaceFitter()
        {
            ...
            surface.SetCV(0, 0, new double[] { -10, -10, 0 });
            surface.SetCV(0, 1, new double[] { -10, 0, 0 });
            surface.SetCV(0, 2, new double[] { -10, 10, 0 });
            surface.SetCV(1, 0, new double[] { 0, -10, 0 });
            surface.SetCV(1, 1, new double[] { 0, 0, 0 });
            surface.SetCV(1, 2, new double[] { 0, 10, 0 });
            surface.SetCV(2, 0, new double[] { 10, -10, 0 });
            surface.SetCV(2, 1, new double[] { 10, 0, 0 });
            surface.SetCV(2, 2, new double[] { 10, 10, 0 });
